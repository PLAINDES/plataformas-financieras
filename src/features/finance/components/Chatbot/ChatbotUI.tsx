        ...
        <div className="w-full h-full flex flex-col gap-4 justify-between">
            ...
            <div className="flex-1 h-full border border-gray-200 rounded-lg overflow-hidden flex flex-col min-h-0">
                <div className="overflow-auto w-full h-full min-h-0">
                    <table className="min-w-160 sm:min-w-full divide-y divide-gray-200 text-sm text-left relative">
            ...
            {avgBetaUnlevered !== undefined && (
                <div className="flex items-center justify-between bg-blue-50/80 border border-blue-200 p-2.5 rounded-lg shadow-sm gap-2">
                    <div className="flex flex-col gap-1">
                        <span className="max-[540px]-text[11px] text-[10px] font-bold text-blue-700 uppercase tracking-wide">
                            BOA Promedio del Sector
                        </span>
                        <span className="text-base sm:text-xl font-black text-gray-900 leading-none mt-0.5">
