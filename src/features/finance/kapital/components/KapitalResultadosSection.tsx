...
const MarketDetailList: React.FC<{ market: MarketResults }> = ({ market }) => (
  <div className="p-6 space-y-4 flex-1">
    {[
      {
        value: market.kd,
        label: "Costo de deuda después de impuestos (Kd*(1-T))",
        color: "green",
      },
      {
        value: market.ke,
...
> = ({ results, formData, resultCurrency, onResultCurrencyChange }) => {
  return (
    <>
      <div>
      ...
      {formData.typeId ? (
        <>
          <div className="grid md:grid-cols-3 gap-4">
            <div
              className={`bg-white rounded-xl border-2 shadow-sm overflow-hidden ${resultCurrency === "usd" ? "border-orange-500" : "border-green-500"}`}
            >
            ...
            {(["emergent", "developed"] as const).map((market) => (
              ...
              >
                ...
                <div className="py-8 text-center">
                  <h2 className="text-4xl font-black text-gray-900 mb-2">
                    {formatterx100p(results[market].cppc)}
                  </h2>
              ...
              <div className="grid lg:grid-cols-3">
                <div className="lg:col-span-2 border-r border-gray-200 p-8">
                  <h3 className="text-base font-bold text-gray-900 mb-6">
                    {market === "emergent"
                      ? "Resultados del mercado emergente"
                      : "Resultados del mercado desarrollado"}
                  </h3>
                  <BalanceSheetBlock
