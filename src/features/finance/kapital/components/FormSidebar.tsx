...
export const FormSidebar: React.FC<FormSidebarProps> = ({
    ...
    return (
        <>
            ...
            {createPortal(
                <div
                    onMouseEnter={handleBetaPanelEnter}
                    ...
                    style={{
                        ...
                        pointerEvents: betaInfoVisible ? "auto" : "none",
                ...
                >
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h4 className="text-[11px] font-bold text-valora-primary mb-1 uppercase tracking-wider">¿Para qué sirve?</h4>
                            <p className="text-[11px] text-gray-600 leading-relaxed">
                                La IA identifica empresas comparables, calcula el beta desapalancado de cada una y obtiene un promedio ponderado por Enterprise Value. Refleja el riesgo operativo del sector eliminando el efecto de la estructura de capital, para estimar el costo de capital en valorizaciones DCF.
                            </p>
                        </div>
                    </div>
                </div>,
