...
const ValoraMethodology: React.FC<{ uid?: string }> = ({ uid = "demo" }) => {
  ...
  const [categories, _setCategories] = useState<Category[]>([
    ...
    },
    {
      ...
      products: [
        {
          name: "WACC - Costo Promedio Ponderado de Capital",
          file: "https://drive.google.com/file/d/1Esm2696i0XB6dAAjhgUUtrI0Z85hWywW/preview",
        },
        {
          name: "Costo de Deuda",
    ...
    },
    {
      ...
      products: [
        ...
        {
          name: "Proyección de Costos y Gastos",
          file: "https://drive.google.com/file/d/1Esm2696i0XB6dAAjhgUUtrI0Z85hWywW/preview",
        },
        {
  ...
  return (
    <div className="valora-page">
      ...
      <div
        className={`aside minimized ${isMobileMenuOpen ? "mobile-open" : ""}`}
      >
                ...
                <div className="menu show">
                  <div className="menu-item px-3">
                    <div className="menu-content">
                      ...
                      <a href="#" className="text-muted fs-8">
                        usuario@demo.com
                      </a>
                    </div>
                  </div>
                  <div className="menu-item px-5">
                    <a href="/usuario/proyectos" className="menu-link fs-7">
                      Mis proyectos
                    </a>
                  </div>
                  <div className="separator" />
                  <div className="menu-item px-5">
                    <a href="/auth/signout" className="menu-link fs-7">
                      Cerrar sesión
                    </a>
                  </div>
                </div>
              ...
              <div className="card shadow-sm">
                <div className="card-header bg-light">
                  <h3 className="card-title fs-6">
                    {selectedFileName || "Selecciona un tema para comenzar"}
                  </h3>
                </div>
                <div className="card-body p-0">
                  {selectedFile ? (
                    ...
                    <div className="text-center py-5">
                      <i
                        className="fa-solid fa-file-pdf text-muted"
                        style={{ fontSize: "4rem" }}
                      />
            ...
            <div className="col-lg-3 mb-3">
              <div className="card shadow-sm">
                <div className="card-header bg-primary">
                  <h3 className="card-title text-white fs-6">
                    Aprende más sobre valoración
                  </h3>
                </div>
                <div className="card-body p-0">
                  {categories.length > 0 ? (
          ...
          <div className="container-xxl">
            <div className="row g-3">
              <div className="col-lg-6">
                <h2 className="fs-6">
                  <i className="fa-regular fa-building me-2" /> Valora
                </h2>
                <p className="fs-8 mb-0">
                  Obtén una valoración precisa y confiable para tomar decisiones
                  informadas de inversión.
                </p>
              </div>
              <div className="col-lg-6">
                <h2 className="fs-6">
                  <i className="fa-solid fa-square-poll-vertical me-2" />{" "}
                  Suscríbete
                </h2>
