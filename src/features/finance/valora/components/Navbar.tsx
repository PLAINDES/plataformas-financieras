    ...
    const items: NavTab[] = [
      {
        ...
        icon: (
          <span
            className={
              selected === "estados" ? "text-blue-600" : "text-gray-400"
            }
          >
            <svg
              width="22"
              height="22"
              viewBox="0 0 896.000000 1152.000000"
            ...
            >
              ...
              >
                <path
                  d="M1062 10401 c-40 -8 -96 -52 -119 -94 -16 -30 -17 -283 -18 -4329 l0
...
315 6 -1 67 -64 137 -138z"
                ...
                <path
                  d="M2120 8424 c-66 -29 -100 -81 -100 -156 0 -81 51 -144 135 -167 51
-14 2928 -15 3025 -1 59 8 69 13 106 54 47 51 61 104 44 164 -13 47 -26 63
-74 96 l-39 26 -1531 0 c-1341 -1 -1535 -3 -1566 -16z"
                />
                <path
                  d="M3165 7671 c-83 -38 -105 -89 -105 -245 l0 -115 -42 -10 c-349 -83
