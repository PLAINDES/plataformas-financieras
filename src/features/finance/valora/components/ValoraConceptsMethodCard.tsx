...
export const ValoraConceptsMethodCard: React.FC<
  ValoraConceptsMethodCardProps
> = ({
  iconClassName,
  headerText,
  patrimonioValue,
    ...
    <div className="bg-white lg:px-10 px-4  p-10 pt-0 rounded-b-lg flex lg:flex-row flex-col w-full lg:gap-10">
      <div className="flex flex-col w-full pt-10">
        <div className="flex justify-between border-b border-gray-200 pb-5 mb-5">
          ...
          <p className="text-lg font-bold text-green-500">{patrimonioValue}</p>
        </div>
        <div className="flex justify-between pb-10">
          <h4 className="text-md font-bold">VALOR POR ACCION</h4>
          <p className="text-lg font-bold text-blue-500">{accionValue}</p>
        </div>
      </div>
      <div className="w-full pt-5">
        <h3 className="text-lg font-bold pb-4 lg:pb-0">
        ...
        <div className="lg:h-11/12  w-full grid grid-rows-6 grid-cols-6 gap-1 lg:p-5 lg:px-5 px-0">
          ...
          <div className="row-span-2 col-start-2 border-3 border-blue-400 rounded-br-lg relative flex justify-center items-center">
            <span className="absolute top-0 text-xs text-[#aaa]">
              Patrimonio
            </span>
          ...
          <div className="row-start-4 col-start-4 row-span-1 text-center text-sm">
            Valor Esperado
          </div>
          ...
          <div className="row-start-4 col-start-6 row-span-1 text-center text-sm">
            Valor Sensibilizado
          </div>
