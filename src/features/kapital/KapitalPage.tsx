...
// Actualiza el NavBar con las nuevas props
<NavBar
...
{/* Actualiza el main con padding-top correcto */}
      ...
      {/* Main Content */}
<main className={`${results ? 'pt-24 lg:pt-16' : 'pt-12 lg:pt-16'} transition-all duration-300 ${isFormOpen && !results ? 'lg:pl-110' : 'lg:pl-0'}`}>
