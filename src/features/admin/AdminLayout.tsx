...
const CubeIcon: FC<{ size?: number }> = ({ size = 20 }) => (
  <Icon size={size}>
    <path
      opacity="0.35"
      d="M11.8 5.2L17.7 8.6V15.4L11.8 18.8L5.9 15.4V8.6L11.8 5.2Z"
      fill="currentColor"
    />
    <path
      d="M11.8 8.7L8.9 10.3V13.7L11.8 15.3L14.7 13.7V10.3L11.8 8.7Z"
      fill="currentColor"
    />
  </Icon>
);
...
const ChevronLeft: FC = () => (
  <Icon size={16}>
    <path
      opacity="0.5"
      d="M14.3 11.4L18.5 7.25C18.9 6.84 18.9 6.16 18.5 5.75C18.0 5.34 17.4 5.34 16.95 5.75L11.4 11.3C11.0 11.68 11.0 12.32 11.4 12.71L16.95 18.25C17.4 18.66 18.0 18.66 18.5 18.25C18.9 17.84 18.9 17.16 18.5 16.75L14.3 12.57C13.95 12.25 13.95 11.75 14.3 11.43Z"
      fill="currentColor"
    />
    <path
      d="M8.27 11.4L12.45 7.25C12.86 6.84 12.86 6.16 12.45 5.75C12.04 5.34 11.36 5.34 10.95 5.75L5.41 11.3C5.02 11.68 5.02 12.32 5.41 12.71L10.95 18.25C11.36 18.66 12.04 18.66 12.45 18.25C12.86 17.84 12.86 17.16 12.45 16.75L8.27 12.57C7.95 12.25 7.95 11.75 8.27 11.43Z"
      fill="currentColor"
    />
  </Icon>
);
...
const BellIcon: FC = () => (
  <Icon size={20}>
    ...
    />
    <path
      d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zM7 13v-2l2-2V7c0-2.21 1.79-4 4-4s4 1.79 4 4v2l2 2v2H7z"
      fill="currentColor"
    />
  </Icon>
);
...
const UpArrow: FC = () => (
  <Icon size={22}>
    ...
    />
    <path
      d="M12.57 8.57L16.75 12.75C17.16 13.16 17.84 13.16 18.25 12.75C18.66 12.34 18.66 11.66 18.25 11.25L12.71 5.71C12.32 5.32 11.68 5.32 11.29 5.71L5.75 11.25C5.34 11.66 5.34 12.34 5.75 12.75C6.16 13.16 6.84 13.16 7.25 12.75L11.43 8.57C11.75 8.25 12.25 8.25 12.57 8.57Z"
      fill="currentColor"
    />
  </Icon>
);
        ...
        <div style={{ position: "relative" }}>
          ...
          {notifOpen && (
            ...
            >
              ...
              >
                <span
                  style={{ fontWeight: 700, fontSize: 15, color: "#3f4254" }}
                >
                  Notificaciones
                </span>
                <span
              ...
              {notifications.map((n, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontSize: 12, color: "#b5bfc9", marginTop: 2 }}
                    >
                      {n.time}
                    </div>
                  </div>
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 11, color: "#b5bfc9" }}>
                Administrador
              </span>
            </div>
            <span
              style={{ color: "#b5bfc9", marginLeft: 2 }}
              className="hide-sm"
            >
              <ChevronDown />
            </span>
          ...
          {profileOpen && (
            ...
            >
              ...
              >
                <div
                  style={{ fontWeight: 700, fontSize: 14, color: "#3f4254" }}
                >
                  Admin User
                </div>
                <div style={{ fontSize: 12, color: "#b5bfc9", marginTop: 2 }}>
                  admin@herramientas.com
                </div>
              </div>
              {profileLinks.map(([label, color]) => (
                <a
                  ...
                  style={{
                    ...
                    transition: "all .15s",
                    borderBottom:
                      label !== "Cerrar Sesión" ? "1px solid #f5f8fa" : "none",
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "#fafbff";
          ...
          <button
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.boxShadow =
                "0 4px 20px rgba(54,153,255,0.3)")
            }
            onMouseLeave={(e) =>
  ...
  <div>
    ...
    >
      ...
      >
        ...
        />
        <span style={{ fontSize: 13, color: "#b5bfc9", fontWeight: 600 }}>
          Dashboards
        </span>
      </div>
    </div>
      ...
      <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
        <div className="py-9 px-10 bg-linear-gradient(135deg, #f8faff 0%, #fff 100%) flex flex-col items-center justify-center text-center">
          ...
          >
            Plataforma
            <br />
            <a href="/" style={{ color: "#3699FF", textDecoration: "none" }}>
              Herramientas
            </a>
          </h2>
          <p
          ...
          >
            Gestiona tus plantillas, reportes y configuraciones desde un solo
            lugar.
          </p>
        </div>
      </div>
