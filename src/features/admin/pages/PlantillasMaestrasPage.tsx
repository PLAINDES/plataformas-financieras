      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Gestión de plantillas Excel base para los módulos Valora y Kapital.
          </p>
        </div>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        ...
                        disabled={uploadingId === t.id || !!t.onedrive_item_id}
                        title={
                          t.onedrive_item_id
                            ? "Ya tiene archivo subido"
                            : "Subir archivo Excel"
                        }
                        className="rounded-md p-1.5 text-gray-500 hover:bg-green-50 hover:text-green-600 transition-colors disabled:opacity-50"
                      >
                        {uploadingId === t.id ? (
                          <svg
                      ...
                      <button
                        ...
                        disabled={reUploadingId === t.id || !t.onedrive_item_id}
                        title={
                          t.onedrive_item_id
                            ? "Re-subir archivo actualizado"
                            : "Sin archivo actual"
                        }
                        className="rounded-md p-1.5 text-gray-500 hover:bg-purple-50 hover:text-purple-600 transition-colors disabled:opacity-50"
                      >
                        {reUploadingId === t.id ? (
                          <svg
                            className="animate-spin h-4 w-4"
                      ...
                      <button
                        ...
                        className="rounded-md p-1.5 text-gray-500 hover:bg-orange-50 hover:text-orange-600 transition-colors"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4"
                      ...
                      <button
                        ...
                        className="rounded-md p-1.5 text-gray-500 hover:bg-indigo-50 hover:text-indigo-600 transition-colors disabled:opacity-30"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4"
