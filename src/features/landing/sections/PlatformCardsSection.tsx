...
function PlatformCard({
    ...
    return (
        ...
        >
            ...
            {!isAvailable && (
                <div className="absolute top-4 left-4 z-20 px-4 py-1.5 bg-white border border-gray-200 text-[#0f172a] text-[11px] font-bold rounded-full uppercase tracking-wide shadow-sm">
                    PRÓXIMAMENTE
                </div>
            )}

            {!isAvailable && (
                <div className="absolute inset-0 z-10 bg-[#e0f1ff]/60 rounded-[20px] pointer-events-none" />
            )}
