        ...
        <div className='bg-white lg:px-10 px-4  p-10 pt-0 rounded-b-lg flex lg:flex-row flex-col w-full lg:gap-10'>
            <div className='flex flex-col w-full pt-10'>
                <div className='flex justify-between border-b border-gray-200 pb-10 mb-10'>
                    ...
                    <p className='text-lg font-semibold text-green-500'>{formatNumber(patrimonioValue)}</p>
                </div>
                <div className='flex justify-between border-b border-gray-200 pb-10 mb-10'>
                    <h4 className='text-md font-semibold'>VALOR DE EMPRESA</h4>
                    <p className='text-lg font-semibold text-red-500'>{formatNumber(empresaValue)}</p>
                </div>
                <div className='flex justify-between pb-10'>
                    <h4 className='text-md font-semibold'>VALOR POR ACCION</h4>
                    <p className='text-lg font-semibold text-blue-500'>{formatNumber(accionValue)}</p>
                </div>
            </div>
