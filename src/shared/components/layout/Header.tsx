                        ...
                        <nav className="hidden lg:flex items-center ml-12 space-x-8">
                            {visibleMenuItems.map((item) => (
                                <a
                                    ...
                                    className={`text-sm font-bold transition-colors hover:text-blue-600 ${activeMenu === item.slug.toLowerCase()
                                            ? "text-blue-600"
                                            : "text-gray-700"
                                        }`}
                                >
                            ...
                            <nav className="flex flex-col space-y-4">
                                {visibleMenuItems.map((item) => (
                                    <a
                                        ...
                                        className={`text-lg font-bold py-2 border-b border-gray-100 ${activeMenu === item.slug.toLowerCase()
                                                ? "text-blue-600"
                                                : "text-gray-800"
                                            }`}
                                    >
