...
export const INDUSTRY_TRANSLATIONS: Record<string, string> = {
  ...
  "Financial Svcs. (Non-bank & Insurance)": "Servicios Financieros (No Bancarios y Seguros)",
  ...
  "Oil/Gas (Production and Exploration)": "Petróleo y Gas (Producción y Exploración)",
  ...
  "Real Estate (Operations & Services)": "Bienes Raíces (Operaciones y Servicios)",
