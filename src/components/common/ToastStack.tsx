...
const toastStyles: Record<ToastType, { className: string; icon: string }> = {
    success: { className: 'border-emerald-200 bg-emerald-50 text-emerald-700', icon: 'fa-circle-check' },
    info: { className: 'border-sky-200 bg-sky-50 text-sky-700', icon: 'fa-circle-info' },
    warn: { className: 'border-amber-200 bg-amber-50 text-amber-700', icon: 'fa-triangle-exclamation' },
    error: { className: 'border-red-200 bg-red-50 text-red-700', icon: 'fa-circle-xmark' }
};
